...
*/
pessoa.tresAniversarios = function() {
  pessoa.idade += 3;
}
...
pessoa.idadeMaiorQueUm = function() {
  if(pessoa.idade === 1){
    return " ano";
  } else {
    return " anos"
...
pessoa.metroOuMetros = function() {
  if(pessoa.andar.caminhouQuantosMetros === 1){
    return " metro";
  } else {
    return " metros";
  };
